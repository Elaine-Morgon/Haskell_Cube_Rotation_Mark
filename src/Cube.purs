  ...
  in
    HH.div [] $
      [HH.div_
        ...
        , renderButton "Add Cube" (Tick)
        , renderButton "Remove Cube" (IncAngVelocity Z)
        ]
      ]
      <>
      [ HH.p_ [HH.text "Click X/Y/Z to rotate along X-axis/Y-axis/Z-axis"]]
      <>
      [HH.div_
        [
          renderButton "change-dir" (IncAngVelocity X)
        , renderButton "vel++" (IncAngVelocity Y)
        , renderButton "vel--" (IncAngVelocity Z)
        ]
      ]
      <>
      [ SE.svg
